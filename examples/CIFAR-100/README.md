...
- **Details:** A more complex ViT model with 256 embedding dimensions and 6 layers, demonstrating how transformers can scale to more complex image tasks.
- **Command:**
...
```bash
python ../../main.py vis --config cifar100_vit.py
```
